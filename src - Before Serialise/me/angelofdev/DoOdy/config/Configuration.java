...
public class Configuration {
	...
	public static MyConfiguration location;
	public static MyConfiguration inventory;
	
	static {
		config = new MyConfiguration();
		location = new MyConfiguration();
		inventory = new MyConfiguration();
		...
		location = MyConfiguration.loadConfiguration("plugins/DoOdy/location.yml");
		inventory = MyConfiguration.loadConfiguration("plugins/DoOdy/inventory.yml");
	}
